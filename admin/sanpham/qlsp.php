         ...
         <div class="card-body">
               <form class="form-horizontal" action="" method="post" name="frmCSVImport" id="frmCSVImport" enctype="multipart/form-data">
                  <div class="input-row">
                     ...
                     <button type="submit" id="submit" name="import" class="btn-submit">Lưu file CSV</button>
                  </div>              
               </form>
            </div>
            <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-2">
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" min="1" id="exampleFormControlInput1" name="soluong" required="required" value="<?php echo $sanpham_chitiet[0]['soluong']; ?>">
                           </div>
                        </div>
                        <div class="form-group col-md-2">
                           <div class="form-group">
                  ...
                  <form action="admin.php?act=qlsp" method="post" enctype="multipart/form-data">
                     <div class="row">
                        ...
                        <div class="form-group col-md-2">
                           <div class="form-group">
                              <label class="form-control-label" for="exampleFormControlInput1">Số lượng<span>*</span></label>
                              <input type="number" class="form-control" min="1" id="exampleFormControlInput1" name="soluong" required="required">
                           </div>
                        </div>
                        <div class="form-group col-md-2">
                           <div class="form-group">
